...
class DataIngestion:
    ...
    def _load_env_variables(self):
        ...
        required_vars = ["GOOGLE_API_KEY", "ASTRA_DB_API_ENDPOINT", "ASTRA_DB_APPLICATION_TOKEN", "ASTRA_DB_KEYSPACE",'GROQ_API_KEY']
        ...
        # print(f"self.google_api_key :: {self.google_api_key}")
        # print(f"self.db_api_endpoint :: {self.db_api_endpoint}")
        # print(f" self.db_application_token :: { self.db_application_token}")
        # print(f"self.db_keyspace :: {self.db_keyspace}")
        # print(f"self.groq_api_key :: {self.groq_api_key}")
